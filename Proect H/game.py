...
class Game:
    ...
    def spawn_insects(self):
        ...
        if t > self.insects_spawn_timer:
            self.insects_spawn_timer = t + TARGET_SPAWN_TIME
            ...
            # משגר עוד מטרות לאחר חצי מהמשחק
    ...
    def draw(self):
        ...
        # הזמן שנישאר 
        timer_text_color = (160, 40, 0) if self.time_left < 5 else COLORS["timer"] # לשנות את הצבע של הטקסט עם קטו מ X שניות
